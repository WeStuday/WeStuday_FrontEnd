...
const Footer = () => {
  return (
    <div className=" bottom-0 right-0">
      <footer className=" bg-[--background-end] text-center lg:px-[180px] text-[#606060] lg:text-right">
        <div className="mx-6 py-10 text-center md:text-right">
          <div className="grid-1 grid  gap-8 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="">
              <div className="mb-4 flex text-[#00052E] justify-center font-semibold uppercase md:justify-start">
                المراحل الدراسية
              </div>
              <p className="mb-4">
